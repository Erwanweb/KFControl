...
class BasePlugin:
    ...
    def onStart(self):
        ...
        if 3 not in Devices:
            Domoticz.Device(Name="Croix", Unit=3, TypeName="Switch", Image=9, Used=1).Create()
    ...
    def onCommand(self, Unit, Command, Level, Color):
        ...
        if (Unit == 5):
            ...
            if Devices[4].nValue == 1:
                DomoticzAPI("type=command&param=udevice&idx={}&nvalue=3&svalue=Commande depuis keyfob {} - Alarme Desarmee".format(
