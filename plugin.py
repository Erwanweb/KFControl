    ...
    def onCommand(self, Unit, Command, Level, Color):
        ...
        if (Unit == 5):
            ...
            if Devices[4].nValue == 1:
                DomoticzAPI("type=command&param=udevice&idx={}&nvalue=0&svalue=Commande alarme depuis keyfob  TEST - Alarme Desarmee".format(
                            self.Alarmlog))
        ...
        if (Unit == 6):
            ...
            if Devices[4].nValue == 1:
                DomoticzAPI("type=command&param=udevice&idx={}&nvalue=0&svalue=Commande alarme depuis keyfob TEST - Alarme Armee".format(
                        self.Alarmlog))
                Domoticz.Debug("updating alarm log - Alarm turned Off by Keyfob")
